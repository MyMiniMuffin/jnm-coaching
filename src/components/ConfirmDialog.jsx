        ...
        <ConfirmContext.Provider value={confirm}>
            ...
            {state && (
                <div className="fixed inset-0 bg-ink/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4 animate-fade-in" onClick={handleCancel}>
                    <Card ref={focusTrapRef} role="dialog" aria-modal="true" aria-labelledby="confirm-dialog-title" className="w-full max-w-sm p-6 animate-scale-in" onClick={e => e.stopPropagation()}>
